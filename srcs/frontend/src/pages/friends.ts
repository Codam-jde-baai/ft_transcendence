...
function setupUserActionListeners() {
	...
	document.addEventListener('user-action', (e: CustomEvent) => {
		const { action, alias, type } = e.detail;
...
// Declare these variables at the right scope for search functionality
let publicUsers: PubUserSchema[] = [];
