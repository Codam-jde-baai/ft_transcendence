		...
		<div class="scontainer">
			...
			<div class="bg-white p-5 rounded-[8px] w-[441px] relative;">
				...
				<div class="buttons mt-[-10px]">
					<button class="mb-2.5 w-[364px] py-3 text-[1.1rem] text-white bg-[#902063] border-none rounded-[5px] cursor-pointer mt-2.5 transition duration-500 box-border font-sans" id="PWSave" data-i18n="btn_Save"></button>
				</div>
			</div>
		</div>
		`);
