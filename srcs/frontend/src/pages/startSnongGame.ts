...
import { startSnek, preGameScreen, restartSnek, resetGame } from '../game/snek/main.ts';
import { gameEndData } from '../game/snek/main.ts';
import { Application } from 'pixi.js'
import { setupErrorPages } from './errorPages.ts';
import DOMPurify from 'dompurify';
import { connectFunc, requestBody } from '../script/connections.ts';
import { setupSnek } from './snek.ts';
